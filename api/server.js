/* cyber-gym-api — passkey (WebAuthn) auth + per-user state storage for Cyber Gym
...
const RP_NAME = process.env.RP_NAME || 'Cyber Gym';
...
}).listen(PORT, () => console.log(`cyber-gym-api on :${PORT} (rpID=${RP_ID}, origin=${ORIGIN})`));
