...
// Hevy primary_muscle_group → Cyber Gym body-part for exercises we invent.
const HEVY_BP = {
...
/**
 * Hevy routine → Cyber Gym routine config.
...
export function parseHevyRoutines(routines, templates, { unit = 'kg' } = {}) {
  ...
  for (const r of routines || []) {
    const ex = []
    const sgMap = new Map() // Hevy superset_id → Cyber Gym sg token
