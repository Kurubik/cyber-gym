...
describe('Brazilian Portuguese locale', () => {
  ...
  test('makes every inherited pt-PT value an explicit reviewed snapshot', () => {
    ...
    expect(inherited).toHaveLength(928)
    // If this fails, review the changed keys and wording before accepting a new hash. From
    // frontend/: node scripts/pt-br-inheritance-fingerprint.mjs --list
    expect(fingerprint, 'pt-PT inheritance changed; review the inherited pt-BR wording').toBe('3651eff58e9c34aec8843a561f513f8da178af317d2d32284316b4034782c322')
  })
