...
//
// Two answers. "Use my self-hosted Cyber Gym" hands the whole thing to the paired server — the
...
export default function CoachSetup() {
  ...
  const current = coachLocal?.mode === 'server' ? t('Runs on your Cyber Gym server')
  ...
  return <div className="narrow">
    ...
    <Section title={t('How should the Coach run?')} footer={current}>
      <Row icon="rocket" iconTint="var(--indigo)" title={t('Use my self-hosted Cyber Gym')}
