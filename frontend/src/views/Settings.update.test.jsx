...
const mocks = vi.hoisted(() => {
  ...
  state.checkForUpdate = vi.fn(() => Promise.resolve({ hasUpdate: true, latestVersion: '9.9.9', apkUrl: 'https://x/cyber-gym.apk', hashUrl: null }))
...
const updateRow = () => [...host.querySelectorAll('.lrow')].find(r => r.textContent.includes('Update to Cyber Gym v9.9.9'))
