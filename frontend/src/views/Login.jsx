...
export default function Login() {
  ...
  // The access node: a chamfered plate with the mark, the wordmark, and a mono status line.
  const head = <>
    <div className="login-mark"><Icon name="dumbbell" /></div>
    <h1 className="wordmark" style={{ fontSize: 30, margin: '16px 0 6px', justifyContent: 'center', display: 'flex' }}>
      CYBER<i>//</i>GYM
    </h1>
    <div className="login-node">{t('BLACKWALL ACCESS NODE')}</div>
  </>
  ...
  if (DEMO) return (
    <div className="narrow" style={wrap}>
      ...
      <div className="card small muted" style={{ textAlign: 'left', marginTop: 16 }}>
        {t('This demo runs entirely in your browser on example data — nothing is sent anywhere. Passkey sign-in and sync across your devices come with the Cyber Gym server, which you get by self-hosting it.')}
      </div>
  ...
  return (
    <div className="narrow" style={wrap}>
      ...
      {webauthnOK() ? <>
        ...
        ? t("This browser doesn't support passkeys — you can still use Cyber Gym locally on this device.")
