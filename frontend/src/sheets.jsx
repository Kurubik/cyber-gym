...
import { fmtDate, fmtNum, capWords, fmtVol, fmtDur, durPart, todayISO, isoOf, uid, exCount, routineCount, DAYN, DAYS, weekOrder, weekStartOf, weekDayOffset, MONTHS_LONG } from './lib/format.js'
...
function PlanTools({ close }) {
  ...
  const exportFile = async () => {
    ...
    const name = 'cybergym-plan-' + todayISO() + '.json'
  ...
  return <>
    ...
    <div className="dim small" style={{ margin: '7px 2px 0', lineHeight: 1.4 }}>{t('A small file a friend imports into their own Cyber Gym — routines only, none of your workouts or weigh-ins.')}</div>
    <div style={{ height: 12 }} />
